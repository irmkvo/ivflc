...
public class VideConference {
    ...
    @RequestMapping("/video/webconf/archive")
    ...
    @RequestMapping("/video/webconf/archive/list/meetingId")
    ...
    @RequestMapping("/video/webconf/helper/{command}/{meetingID}/{recordID}")
    ...
    // CREATE BROADCAST
    @RequestMapping("/admin/webconf/create/{ID}")
    ...
    @RequestMapping("/admin/webconf/create/save")
    ...
    // DELETE BROADCAST
    @RequestMapping("/admin/webconf/delete/{ID}")
    ...
    // START BROADCAST 
    @RequestMapping(value = "/video/webconf/start/{meetingId}", method = RequestMethod.GET)
