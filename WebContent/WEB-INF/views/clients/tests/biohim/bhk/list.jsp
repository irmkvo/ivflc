    ...
    return function ( sSource, aoData, fnCallback ) {
        ...
        $(document).ready(function () {
            $('#dataTables').dataTable({
                ...
                "sAjaxSource": '${pageContext.request.contextPath}/biohim-bhk/json/${modelId}',
                            "aoColumns": [
                                {"mData": "dateConsultation"},
                                    {"mData": "module"},
                                    {"mData": "medecins"},
                                    {"mData": null, "bSortable": false, "mRender": function (o) {
                                            return '<a href="${pageContext.request.contextPath}/biohim-bhk/print/' + o.motconsuId + '">' + 'Подробно' + '</a>';
                                            }
                                    }
                                    ]
                            });
